...
def Main():
    ...
    Examples = optparse.OptionGroup(Menu, "Examples", """python3 preauth.py -u http://127.0.0.1 --dbs
                                                         python3 preauth.py -u http://127.0.0.1 -D chitor_db --tables
                                                         python3 preauth.py -u http://127.0.0.1 -D chitor_db -T login --dump
    """)
